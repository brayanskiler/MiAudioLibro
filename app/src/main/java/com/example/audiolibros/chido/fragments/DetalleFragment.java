...
import com.example.audiolibros.chido.Aplicacion;
import com.example.audiolibros.chido.Libro;
import com.example.audiolibros.chido.MainActivity;
...
public class DetalleFragment extends Fragment implements
    ...
    public void onStart() {
        ...
        Intent intent = new Intent(getActivity().getApplicationContext(),LocalService.class);
    ...
    private static final int idUnica = 100;

    @Override
    public View onCreateView(LayoutInflater inflador, ViewGroup
            contenedor, Bundle savedInstanceState) {

        notificacion =  new NotificationCompat.Builder(getActivity().getApplicationContext());
    ...
    @Override public void onPrepared(MediaPlayer mediaPlayer) {
        notificacion.setSmallIcon(R.drawable.books);
        notificacion.setTicker("Nueva notificacion");
        notificacion.setPriority(Notification.PRIORITY_HIGH);
        notificacion.setWhen(System.currentTimeMillis());
        notificacion.setContentTitle("AudioLibros");
        notificacion.setContentText("Reproduccion de libros en curso");
       ...
       // mediaPlayer.start();
        ...
        if (preferencias.getBoolean("pref_autoreproducir", true)) {
            ...
            Intent intent = new Intent(getActivity().getApplicationContext(),LocalService.class);
            mService.startForeground(0,new Notification());
